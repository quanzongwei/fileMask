 ...
 * @date 2020/1/10
 */
public class SimpleEncryptionAlgorithmV2TagXor {
...
//        try (RandomAccessFile raf =  new RandomAccessFile(new File("D:\\Data\\网龙-整理.rar"), "rw")) {
        try (RandomAccessFile raf = new RandomAccessFile(new File("D:\\Data\\测试\\PPT资料包 - 副本.rar"), "rw")) {
